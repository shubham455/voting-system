<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPage.aspx.cs" Inherits="Voating_System.UserPage" %>
                ...
                <div class="news-agileinfo">
                    <div class="col-md-4 col-xs-6 news-grid">
                        <div class="col-xs-5 news-grid-left">
                            ...
                            <br />
                            <asp:GridView ID="gridview1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Height="157px" Width="1134px" OnSelectedIndexChanged="gridview1_SelectedIndexChanged">
                                <Columns>
                                   <asp:BoundField DataField="CandidateID" HeaderText="ID" />
                                    ...
                                    <asp:BoundField DataField="PartyName" HeaderText="PartyName" SortExpression="Name" />
                                    ...
                                    <asp:ButtonField CommandName="Select" HeaderText="Vote" ShowHeader="True" Text="Vote" />                                
                                </Columns>
